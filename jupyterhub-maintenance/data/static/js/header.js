document
  .getElementById("navbarbtn-links")
  .addEventListener("mouseover", function () {
    menu_hover("navbarbtn-links", "navbarmenu-links", "thenavbar");
  });
...
document
  ...
  .addEventListener("mouseout", function () {
    menu_hover_off("navbarmenu-links");
  });
...
document
  .getElementById("navbarbtn-links-1")
  .addEventListener("mouseover", function () {
    submenu_hover(
      "navbarbtn-links-1",
      "navbarmenu-links-1",
...
document
  .getElementById("navbarbtn-links-2")
  .addEventListener("mouseover", function () {
    submenu_hover(
      "navbarbtn-links-2",
      "navbarmenu-links-2",
...
document
  .getElementById("navbarbtn-links-3")
  .addEventListener("mouseover", function () {
    submenu_hover(
      "navbarbtn-links-3",
      "navbarmenu-links-3",
