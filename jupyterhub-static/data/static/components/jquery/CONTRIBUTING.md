...
Note: This is the code development repository for _jQuery Core_ only. Before opening an issue or making a pull request, be sure you're in the right place.
...
Most bugs reported to our bug tracker are actually bugs in user code, not in jQuery code. Keep in mind that just because your code throws an error inside of jQuery, this does _not_ mean the bug is a jQuery bug.
