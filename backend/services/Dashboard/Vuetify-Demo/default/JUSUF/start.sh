...
# Run Voila stuff
git clone --branch v0.2.2 https://github.com/voila-dashboards/voila-vuetify.git
voila --no-browser --base_url=${JUPYTERHUB_SERVICE_PREFIX}/ --Voila.ip=0.0.0.0 --port=${JUPYTER_JSC_PORT} --theme dark --template vuetify-default ./voila-vuetify/bqplot_vuetify_example.ipynb &
